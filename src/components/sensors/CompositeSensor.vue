        ...
        <v-expansion-panel flat>
          <v-expansion-panel-content class="pa-2">
            ...
            <v-card class="text-md-center align-center">
              ...
              <v-layout v-for="(measure) in sensorDisplay.complex_measurements.measurements" :key="measure.timestamp">
...
export default {
  ...
  methods: {
    ...
    prepareDataForChart(sensorData) {
      ...
      var data = [];
      sensorData.complex_measurements.measurements.forEach(meassure => {
        data.push({
          y: meassure.value,
